...
import Generate from '../uniquegen'; // function for generating a random word
...
export default function GenerateBoolean (ArrayOFboolean: bool[]): bool {
    const RandomIndex: number = Generate.randomNumber(1, true, [0, 1]); // Generate Random Index Between 0 and Array Length - 1
