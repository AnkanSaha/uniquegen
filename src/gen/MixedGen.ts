...
final symbol string of the specified length. */
  ...
  while (length > 0) {
    ...
    const FinalRandomNumForMixed: num = GenerateNumberIndex(MixedArray); // Generate Random Number Index Between 0 and Array Length - 1
...
function GenerateNumberIndex(ArrayMixed:str[]): num {
